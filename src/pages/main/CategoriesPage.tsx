...
export function CategoriesPage() {
    ...
    async function updCat(e: Event) {
        e.preventDefault()
        const resp = await updateCat(updateId, title, slug).catch((err) => {
            setError(true)
            setErrorText(err.response.data.message)
        })
        if (resp && resp.status == 200) {
                        ...
                        {cats.map(cat =>
                            <div className="categories__block">
                                ...
                                <div className="categories__controls">
                                    <div className="categories__update" onClick={() => { rewriteCat(cat.id, cat.title, cat.slug) }}>
                                    ...
                                    <div className="categories__delete" onClick={() => { delCat(cat.id) }}>
